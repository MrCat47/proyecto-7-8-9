...
let milisegundos = horas*60*60*1000 + minutos*60*1000 + segundos*1000;

console.log(`la cantidad de milisegundos que hay en ${horas} hora,
 ${minutos} minutos y ${segundos} es de ${milisegundos}`); 
